...
import { PHONETIC_FAMILY } from "./globals";
 ...
 */
export function generateAllPossibleAlignmentStrings(
  word1Length: number, word2Length: number): string[] {
